...
module PgORM
  abstract class Base < ActiveModel::Model
    ...
    macro default_primary_key(name, autogenerated = true, converter = nil)
      attribute {{name.var}} : {{name.type.resolve}}, mass_assignment: {{!autogenerated}},
            primary_key: true, autogenerated: {{autogenerated}}, converter: {{converter}}
    end
    ...
    {% end %}
     ...
     {% else %}
        ...
        attribute id : Int64, mass_assignment: false, primary_key: true, autogenerated: true
